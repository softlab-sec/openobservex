...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/slo", label: "SLOs", icon: "M3 12a9 9 0 1018 0 9 9 0 00-18 0zM12 7v5l3 2" },
      { href: "/maintenance", label: "Maintenance", icon: "M14 6l-4 4m0 0l-6 6 2 2 6-6m-2-2l2-2 4 4-2 2" },
    ],
  },
  {
    title: "Manage",
