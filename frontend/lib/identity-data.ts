// Shared reference data for the identity/registration experience.
// Full ISO-3166 set. Flag emoji is derived from the ISO2 code at render time
// (two regional-indicator letters), so it is not stored here.

export type Country = { name: string; code: string; dial: string; pinned?: boolean };
...
export const COUNTRIES: Country[] = [
  { name: "Nigeria", code: "NG", dial: "+234", pinned: true },
  { name: "Canada", code: "CA", dial: "+1", pinned: true },
  { name: "India", code: "IN", dial: "+91", pinned: true },
  { name: "United Arab Emirates", code: "AE", dial: "+971", pinned: true },
  { name: "United Kingdom", code: "GB", dial: "+44", pinned: true },
  { name: "United States", code: "US", dial: "+1", pinned: true },
